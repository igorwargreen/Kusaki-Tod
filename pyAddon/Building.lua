...
--    enabled = false,
    ingredients = {
      {type = "item", name = "stone-brick",        amount = 256},
      {type = "item", name = "steam-engine",       amount = 8},
      {type = "item", name = "inductor1",     amount = 32},
      {type = "item", name = "small-parts-01",       amount = 64},
      {type = "item", name = "burner-mining-drill", amount = 8},
    },
...
--    enabled = false,
    ingredients = {
      ...
      {type = "item", name = "refined-concrete",       amount = 128},
      {type = "item", name = "aluminium-plate",       amount = 32},
      {type = "item", name = "tin-plate",       amount = 32},
    },
...
--    enabled = false,
    ingredients = {
      ...
      {type = "item", name = "planter-box",       amount = 48},
    },
...
--    enabled = false,
    ingredients = {
      ...
      {type = "item", name = "duralumin",       amount = 48},
      {type = "item", name = "cage",       amount = 16},
      {type = "item", name = "water-barrel",       amount = 16},
      {type = "item", name = "plastic-bar",       amount = 48},
    },
...
--    enabled = false,
    ingredients = {
      ...
      {type = "item", name = "small-lamp",       amount = 80},
    },
...
data.raw["recipe"]["barrel-machine-mk01"].ingredients = UCM5
